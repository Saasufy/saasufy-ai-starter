---
name: saasufy-websocket-api
description: This skill helps you interact with Saasufy directly via a WebSocket API. This is for more advanced use cases where it's not possible to implement the functionality declaratively using only Saasufy components.
---
