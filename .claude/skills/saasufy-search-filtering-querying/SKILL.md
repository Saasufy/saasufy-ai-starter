---
name: saasufy-search-filtering-querying
description: This skill helps you to construct queries to pass to views/ModelView with Saasufy to display filtered results from a collection.
---
