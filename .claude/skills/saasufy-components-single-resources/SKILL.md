---
name: saasufy-components-single-resources
description: Helps you use Saasufy components related to displaying single resources such as the model-input, model-text and model-viewer components.
---
