---
name: saasufy-components-application-state
description: Helps you use Saasufy components related to routing and application state management such as the app-router and socket-provider components.
---
